...
<table width="100%" style="margin: 4px 0px;" cellpadding="0"
	cellspacing="0">
	<tr>
		<td width="70%"><s:form id="pageQueryForm" action="queryxx.do" cssStyle="margin:auto;" method="post">&nbsp;
		...
		<a href="edit.do?&&zx=0" title="添加规章制度条例"> <img src="${ctx}/images/icons/add.gif">&nbsp;新建</a> &nbsp;&nbsp;
		 <a href="javascript:changeUser('pageQueryForm','确认要删除信息吗?');" title="删除规章制度条例"> <img src="${ctx}/images/icons/delete.gif">删除</a></td>
	</tr>
</table>
</div>
...
<table id="fineTable" width="800">
	...
	<s:iterator value="items" var="item" status="st">
		<tr onmousemove="this.className='trOver';"
			...
			<td width="35" align="center"><input type="checkbox" name="selectedItems" id="selectedItems" value="${item.id}" class="checkbox" /></td>
			...
			<td width="300" align="left">${item.zdContent} <input type="hidden" name="item.ruleType.zcMc" value="${item.ruleType.zcMc}" /></td>
			<td align="center" valign="middle"><a href="edit.do?model.id=${item.id}&&zx=1" title="修改规章制度条例"> <img src="${ctx}/images/icons/edit.png"> </a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		</tr>
	</s:iterator>
	<tr>
