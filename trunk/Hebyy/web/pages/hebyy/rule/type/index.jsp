		...
		<div id="r_tool">
			<div align="right">
				<s:form id="pageQueryForm" action="queryxx.do" cssStyle="margin:auto;" method="post">&nbsp;
						<a href="edit.do" title="添加类别"> <img src="${ctx}/images/icons/add.gif">&nbsp;新建</a> &nbsp;&nbsp;
						<a href="javascript:changeUser('pageQueryForm','确认要删除信息吗?');" title="删除章程目录" > 
						<img src="${ctx}/images/icons/delete.gif">删除</a> 
						<a href="javascript:window.location.href='${ctx}/rule/queryxx.do';" title="返回规章制度管理页面"> 
			...
			<table id="fineTable" width="800">
				...
				<s:iterator value="items"  var="item" status="st">
					<tr onmousemove="this.className='trOver';"
						...
						<td align="center" valign="middle"><a href="edit.do?model.id=${item.id}" title="修改类别名称"> <img 	src="${ctx}/images/icons/edit.png">
						</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					</tr>
				</s:iterator>
				<tr>
...
<script type="text/javascript">
	...
	<script type="text/javascript">
		function jkjsSave() {
			$('#pageQueryForm').attr("action", "${ctx}/ruleType/toAll.do");
