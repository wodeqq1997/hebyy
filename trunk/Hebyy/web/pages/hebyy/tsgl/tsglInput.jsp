...
<body>
	<div class="x-header" style="border-bottom: 1px solid #99bbe8;" >
		当前位置： <span class="r_nav_item">图书管理</span> <span
			class="r_nav_item">图书信息编辑页面</span>
	</div>
 ...
 <legend>基本信息</legend>
		...
		<tr>
					<td width="150" align="right"><span class="warn">*</span> 图书名称:</td>
					<td width="300"><input id="sm" name="model.tsMc"
				...
				<tr>
					...
					<td ><input id="zz" name="model.author"
						value="${model.author}" style="width:280px;"> </td>

				</tr>
				<tr>
					<td  align="right"><span class="warn">*</span>图书类别:</td>
					<td ><s:select name="model.lbmc" list='names'
							cssStyle="width:280px;height:22px; " headerKey="" headerValue="请选择" /></td>

				</tr>
				<tr>
						<td align="right"> 图书照片：</td>
						<td>
							<s:if test="model.bookPhoto == null || model.bookPhoto == ''">							
								<div id="file_buttom">
								  <table>
								    <tr>
								...
								<div id="systop-uploaded-files">
									<s:hidden id="fileAttchIds" name="model.bookPhoto" onpropertychange="updateCarPhoto();"/>
								</div>
				...
				<tr>
					...
					<td ><input id="isbn" name="model.totalNum"
						value="${model.totalNum}" style="width:280px; "> </td>

				</tr>
				
				<tr>
					<td  align="right"><span class="warn" >*</span> 入库时间：</td>
					<td ><input type="text" id="rktime" name="model.rkTime" style="width:280px; " readonly="readonly" 
				...
				<tr>
					...
					<td colspan="2">
					<s:textarea id="ms" name="model.descn"  cssStyle="width:580px;height: 80px;"/>
	...
	<script type="text/javascript">
		function jkjsSave() {
			...
			if (rktime == null || rktime.length == 0) {
				alert("请填写入库时间！");
				return;
			}
			
			
			$('#bmxxForm').attr("action", "${ctx}/tsgl/jkjsSave.do");
			$('#bmxxForm').submit();
		}
