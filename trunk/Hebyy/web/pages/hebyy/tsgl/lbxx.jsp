	...
	<div id="r_main">
		...
		<div id="r_tool">
			<div>
				<s:form id="pageQueryForm" action="queryxx.do" cssStyle="margin:auto;" method="post">&nbsp;
					...
					&nbsp;&nbsp;
						<a href="edit.do" title="添加图书类别"> 
						<img src="${ctx}/images/icons/add.gif">&nbsp;新建</a>
						&nbsp;&nbsp;
						<a href="javascript:changeUser('pageQueryForm','确认要删除信息吗?');" title="删除图书类别"
							> <img
								src="${ctx}/images/icons/delete.gif">删除</a> 
						<a href="javascript:window.location.href='${ctx}/tsgl/queryxx.do';" title="返回图书管理页面"> 
		...
		<div style="margin: 10px;">
			<table id="fineTable" width="800">
				...
				<s:iterator value="lbList"  var="item" status="st">
...
<script type="text/javascript">
	...
	<script type="text/javascript">
		function jkjsSave() {
			$('#pageQueryForm').attr("action", "${ctx}/lbxx/toAll.do");
