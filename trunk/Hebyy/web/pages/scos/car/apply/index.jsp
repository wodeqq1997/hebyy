		...
		<table width="99%">
			<tr>
				<td>
					...
					审核状态：<s:select name="model.status" id="status" list="statusMap" headerKey="" headerValue="全部"/>
...
<table id="fineTable" width="800">
	...
	<s:iterator value="#attr.items"  var="item" status="st">
		<tr onmousemove="this.className='trOver';"
			...
			<s:elseif test="#attr.item.status == 2">
				审核未通过
			</s:elseif>
			<s:else>
			         未进行审核
			...
			<td align="center">
				<s:if test="#attr.item.status == @com.systop.scos.car.CarConstants@CAR_APPLY_NOT_EXAMINE">
			...
			<a href="view.do?model.id=${item.id}" title="查看">详情</a> 
		</td>
		</tr>
	</s:iterator>
	<tr>
