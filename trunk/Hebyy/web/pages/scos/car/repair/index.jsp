...
<title>车辆维修记录管理</title>
<link href="${ctx}/styles/treeSelect.css" type='text/css' rel='stylesheet'>
<script type="text/javascript" src="${ctx}/scripts/my97/WdatePicker.js"></script>
<script type="text/javascript" src="${ctx}/pages/scos/car/selector.js"></script>
<script type="text/javascript">
function remove(id) {
	if(confirm("确认要删除该车辆维修记录？")) {
		window.location.href = URL_PREFIX+"/car/repair/remove.do?model.id=" + id;
	}
}
</script>
</head>
...
<div class="x-panel-header">
	<div style="float: left;">车辆维修记录管理</div>
</div>
<div class="x-toolbar">
	...
	<table width="100%">
	  <tr>
			<td>
				维修类型：<s:select list="#{'维修':'维修','保养':'保养'}" name="model.repairType" headerKey="" id="carType" headerValue="全部" cssStyle="width:60px;" />
				汽车牌照：<s:textfield id="engineNo" name="model.car.carNo" />
			...
			<td align="right">
				<a href="${ctx}/car/repair/edit.do">
					<img src="${ctx}/images/icons/add.gif">添加车辆维修记录</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
			</td>
		</tr>
	</table>
...
<table id="fineTable" width="800">
	...
	<s:iterator value="#attr.items"  var="item" status="st">
		<tr onmousemove="this.className='trOver';"
            ...
            <td align="center"><a href="${ctx}/car/view.do?model.id=${item.car.id}" target="_blank">${item.car.carNo}</a></td>
			<td align="center">${item.repairType }</td>
