...
<div class="x-toolbar">
	...
	<table width="100%">
	  <tr>
			<td>
				交接日期：<input id="date" name="date" value='<s:date name="date" format="yyyy-MM-dd"/>' onfocus="WdatePicker({skin:'blueFresh',dateFmt:'yyyy-MM-dd'})" class="Wdate" readonly="readonly" style="height: 20px;width: 200px;"/>
                <input type="submit" value="查询" class="button" />
            </td>
			<td width="20%" align="right">
				<a href="${ctx}/car/transfer/edit.do"><img src="${ctx}/images/icons/add.gif"/>添加车辆交接记录</a>				
			</td>
		</tr>
	</table>
	</s:form>
	...
	<s:iterator value="#attr.items"  var="item" status="st">
		<tr onmousemove="this.className='trOver';"
			...
			<td align="center">${item.recipient }</td>
			 <td align="center"><fmt:formatDate value="${item.date}" pattern="yyyy-MM-dd"/></td>
