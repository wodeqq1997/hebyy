...
function remove(id) {
	if(confirm("确认要删除？")) {
		window.location.href = URL_PREFIX+"/goods/remove.do?model.id=" + id;
	}
}
</script>
</head>
...
<div class="x-toolbar">
	...
	<s:hidden name="ec_p" id="ec_p"/>
	    ...
	    <td width="40%" align="right">
	    	...
	    	<a href="${ctx}/goods/edit.do">添加物品</a>
	    	&nbsp;
	    	<img src="${ctx}/images/icons/folder.gif" class="icon">
	    	<a href="${ctx}/goods/type/index.do">物品类别管理</a>
	    	&nbsp;
	    	<img src="${ctx}/images/icons/folder.gif" class="icon">
	    	<a href="${ctx}/goods/instock/index.do">入库单管理</a>
	    	&nbsp;
	    </td>
	  </tr>
	</table>
