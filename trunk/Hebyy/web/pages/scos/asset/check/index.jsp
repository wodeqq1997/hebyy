...
<div class="x-toolbar"><s:form action="index.do"
	...
	<table width="100%">
		<tr>
			<td>设备物资名称：<s:textfield id="model.asset.name" name="assetName"
				style="width:200px;" /> <input type="submit" value="查询"
				class="button" /></td>
			<td align="right"><a href="${ctx}/asset/check/edit.do"><img
				src="${ctx}/images/icons/add.gif">添加检测记录</a></td>
		</tr>
	</table>
</s:form></div>
...
<table id="fineTable" width="800">
	...
	<s:iterator value="#attr.items" var="item" status="st">
		<tr onmousemove="this.className='trOver';"
			...
			<td align="center"><fmt:formatDate value="${item.checkDate}"
				pattern="yyyy-MM-dd" /></td>
			<td><fmt:formatDate value="${item.correctDate}"
				pattern="yyyy-MM-dd" /></td>
