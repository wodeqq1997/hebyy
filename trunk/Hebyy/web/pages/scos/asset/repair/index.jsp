	...
	<table width="100%">
	  <tr>
			<td>
				...
				物资名称：<s:textfield id="engineNo" name="assetName"  style="width:100px;"/>
			...
			<td align="right">
				<a href="${ctx}/asset/repair/edit.do"><img src="${ctx}/images/icons/add.gif">添加物资维修记录</a>
			</td>
		</tr>
	</table>
	</s:form>
...
<table id="fineTable" width="800">
	...
	<s:iterator value="#attr.items"  var="item" status="st">
		<tr onmousemove="this.className='trOver';"
			...
			<td align="center"><fmt:formatDate value="${item.repairDate}" pattern="yyyy-MM-dd"/></td>
