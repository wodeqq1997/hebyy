...
<div class="x-toolbar" style="border-color: ">
<s:form action="showUsers" theme="simple" id="pageQueryForm">
	...
	<table width="1125px">
		<tr>
			...
			<td style="text-align: right; padding-right: 1em;" width="30%">
...
<div class="x-panel-body" style="width: 1125px; ">
...
<s:iterator value="#attr.items"  var="item" status="st">
		<tr onmousemove="this.className='trOver';"
			...
			<td width="150" ellipsis="true">${item.college}&nbsp;${item.major}</td>
			<td width="70" cell="date" format="yyyy-MM-dd">${item.graduationTime}</td>
			<td width="70" cell="date" format="yyyy-MM-dd">${item.joinTime}</td>
			<td  width="80" ellipsis="true">${item.enterpriseExt.technical}</td>
			<td width="80" style="text-align:center">${item.mobile}</td>
			...
			<a href="${ctx}/certificate/index.do?model.user.name=${item.name}" title="员工证书信息">证书信息</a>|
