...
<div id="r_main">
  <div class="x-panel-header">考勤管理</div>
    <div class="x-toolbar" style="position: relative;">
		<s:form action="index" theme="simple" id="pageQueryForm" method="post">

            &nbsp;&nbsp;年份：<input id="dateYear" name="dateYear" value='${dateYear}'  onfocus="WdatePicker({skin:'blueFresh',dateFmt:'yyyy'})" class="Wdate" readonly="readonly" style="height: 20px;"/>
            ...
            <span style="position: absolute;right: 0.75em;"><a href="${ctx}/attendance/edit.do"><img src="${ctx}/images/icons/add.gif" />新建考勤</a></span>
	...
	<tr>
		<td colspan="4" style="border: 0px; padding-top: 4px;"
	...
	<s:iterator value="#attr.items"  var="item" status="st">
		<tr onmousemove="this.className='trOver';"
            ...
            <td align="center"><a href="javascript:" onclick="open_Attendance('${item.id}')"><font color="blue"><fmt:formatDate value="${item.attendanceDate}" pattern="yyyy年MM月"/>【${item.dept.name}】考勤记录</font></a></td>
