...
import com.systop.scos.car.service.CarUseRecordManager;
...
public class CarUseRecordAction extends DefaultCrudAction<CarUseRecord, CarUseRecordManager> {
	...
	private Map<String, Object> buildQuery(User user) {
		...
		StringBuffer sql = new StringBuffer("from CarUseRecord c where 1=1");
	...
	public String passCarApply() {
		if (getModel() != null) {
			getModel().setStatus(CarConstants.CAR_APPLY_PASS);
