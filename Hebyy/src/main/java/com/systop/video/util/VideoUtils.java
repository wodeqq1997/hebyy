...
public final class VideoUtils {
	 ...
	 */
	public static IClient getClient(IScope scope, String user) {
	 ...
	 * @return 是否包含
	 */
	public static boolean hasIt(String membersStr, String userId) {
	 ...
	 * @return 剔除后的字符串
	 */
	public static String removeBlock(String memberStr, String userId) {
	...
	public static User getCurrentUser(UserManager userManager) {
		...
		return userManager.get(getUserIdByClient(conn.getClient()));
	}

	public static String getCurrentUserName() {
		IConnection conn = Red5.getConnectionLocal();
		return getUserIdByClient(conn.getClient());
	...
	/**
	 * 得到某个IClient对象关联的用户loginId
	 * 
	 * @param client
	 *            the instance of IClient
	 */
	public static String getLoginIdByClient(IClient client) {
		Assert.notNull(client);
		return (String) client
				.getAttribute(VideoConstants.USER_CLIENT_ATTR_KEY);
	}
