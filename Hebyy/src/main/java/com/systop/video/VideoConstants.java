...
public final class VideoConstants {
	 ...
	 * 播放視頻文件開始
	 */
	public static final String CLIENT_METHOD_ON_MOVIE_BROADCAST_CLOSE = "stopMovie";
	/**
	 * 播放視頻文件開始
	 */
	public static final String CLIENT_METHOD_ON_MOVIE_BROADCAST_START = "playMovie";
	 ...
	 * slider按下事件
	 */
	public static final String movieSlider_thumbPressHandler = "movieSlider_thumbPressHandler";
	/**
	 * slider释放下事件
	 */
	public static final String movieSlider_thumbReleaseHandler = "movieSlider_thumbReleaseHandler";

	/**
	 * 改变Slider位置的响应事件，同时调整播放进度
	 */
	public static final String movieSlider_changeHandler = "movieSlider_changeHandlerCallBack";

	/**
	 * 进度条鼠标按下事件
	 */
	public static final String movieSlider_mouseDownHandler = "movieSlider_mouseDownHandler";

	/**
	 * 停止播放历史视频的按钮响应事件
	 */
	public static final String movieStop_clickHandler = "movieStop_clickHandlerCallBack";

	/**
	 * 进度条鼠标释放事件
	 */
	public static final String movieSlider_mouseUpHandler = "movieSlider_mouseUpHandler";

	/**
	 * 暂停按钮响应事件
	 */
	public static final String moviePause_clickHandler = "moviePause_clickHandlerCallBack";
	/**
	 * 调整音量事件
	 */
	public static final String sound_thumbChanges = "sound_thumbChangesCallBack";
}
