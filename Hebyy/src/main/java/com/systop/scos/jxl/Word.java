...
public class Word {
	...
	public void getWord(String path){
	}
	...
	public static void main(String args[]) throws Exception {
		...
		//word.
		word.insertText("123");
		// msWordManager.copyParagraphFromAnotherDoc("F:/java操作word.doc", 1,
		// "3");
		word.insertImage("D:/Backup/我的文档/800x600.jpg");
		word.moveEnd();
