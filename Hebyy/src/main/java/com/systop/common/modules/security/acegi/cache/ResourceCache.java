...
/**
 * Cache of <code>ResourceDetails</code>. 为<code>ResourceDetails</code>
 * 对象提供缓存支持的接口。
 * 
 * @author Sam
 * 
...
public interface ResourceCache {
	 ...
	 * @param resString
	 *            给定资源String
	 * @return <code>ResourceDetails</code>对象，如果没有，返回 <code>null</code>.
	 */
	 ...
	 *            给定<code>ResourceDetails</code>对象
	 */
