...
public class ArchiveTypeAction extends
		DefaultCrudAction<ArchiveType, ArchiveTypeManager> {
	...
	@Override
	public String index() {
		StringBuffer sql = new StringBuffer("from ArchiveType a where 1=1");
	...
	public String remove() {
		try {
			...
			setModel(null);
			addActionError("该档案类型已经使用，不允许删除");
			return this.index();
		}
	}
}