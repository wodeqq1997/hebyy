		...
		<td width="70%"><s:form action="index.do" method="post"
	 	...
	 	&nbsp;入库单日期：<input id="cDate" name="cDate" value='${cDate}'
			...
			<td width="30%" align="right"><a
				href="${ctx}/goods/instock/edit.do"> <img
				src="${ctx}/images/icons/add.gif">&nbsp;添加物品入库单</a> &nbsp;&nbsp; <a
				href="${ctx}/goods/index.do"> <img
				src="${ctx}/images/icons/rem-all.gif">&nbsp;物品管理</a></td>
		</s:form>
	</tr>
</table>
</div>
...
<table id="fineTable" width="800">
	...
	<s:iterator value="#attr.items" var="item" status="st">
		<tr onmousemove="this.className='trOver';"
			...
			<td>${item.buyer }</td>
			<td align="center"><a href="edit.do?model.id=${item.id}"> <img
	...
	<s:if test="#attr.items.size()!=0">
		<tr style="background-color: #ffe3ee">
			...
			<td
				style="font-weight: bold; word-wrap: break-word; word-break: break-all; text-align: right">${totalInCounts}</td>
			<td>&nbsp;</td>
			<td
				style="font-weight: bold; word-wrap: break-word; word-break: break-all; text-align: right">${totalAmount}</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
