...
<div class="x-toolbar"><s:form action="myIndex" theme="simple"
	id="pageQueryForm">
	<s:hidden name="ec_p" id="ec_p" />
	<table width="99%">
		<tr>
			<td>申请状态：<s:select list="statusMap" name="model.status"
				headerKey="" id="status" headerValue="全部" cssStyle="width:60px;" />
			车辆牌照：<s:textfield id="carNo" name="model.car.carNo" /> 申请日期：<input
			...
			<td align="right" width="20%"><img
				src="${ctx}/images/icons/add.gif" style="width: 12px; height: 12px;">&nbsp;<a
				href="${ctx}/car/apply/edit.do">申请车辆</a></td>
		</tr>
	</table>
</s:form></div>
	...
	<s:iterator value="#attr.items" var="item" status="st">
		<tr onmousemove="this.className='trOver';"
			...
			<td align="center"><a href="view.do?model.id=${item.id}"
				title="查看"><img src="${ctx}/images/icons/zoom.gif"></a>&nbsp;
