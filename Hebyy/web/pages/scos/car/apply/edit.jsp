...
<title>添加汽车使用申请</title>
</head>
<body>
	<div class="x-panel">
		<div class="x-header" style="border-bottom: 1px solid #99bbe8;">
			<div style="float: left;">添加汽车使用申请</div>
			<div style="float: right;display: inline;"><a href="${ctx}/car/apply/myIndex.do">返回</a></div>
		</div>
				...
				<table width="700" border="0" align="center" style="line-height: 20px; margin-top: 20px; margin-bottom: 20px; margin-bottom: 20px;" id="fineTable">
					...
					<tr>
						...
						<td width="270">
							...
							<s:textfield name="model.proposer.name" id="proposer"  cssClass="required" maxlength="255" readonly="true"/>
							<font color="red">*</font>
<!-- 							onclick="showPresideUser(this)" -->
						</td>
					...
					<tr>
						<td align="center">选择车辆：</td>
						<td>
							<s:textfield id="carNo" name="model.car.carNo" onclick="showCar()"  readonly="true"/><s:hidden name="model.car.id" id="carId" /><!--							<input name="button2" id="carButton" type="button" class="button" onclick="" value="选择" />-->
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3">
							<s:textfield name="model.reason" id="reason" cssClass="required" cssStyle="width: 580px;"/>
