...
<div class="x-toolbar"><s:form action="index.do"
	...
	<table width="100%">
		...
		<tr>
			<td>车牌：<s:textfield id="carNo" name="model.carNo" /> 汽车类型：<s:select
				list="#{'轿车':'轿车','货车':'货车','商务车':'商务车'}" name="model.carType"
				headerKey="" id="carType" headerValue="全部" cssStyle="width:110px;" />
			购买日期：<input id="startDate" name="startDate"
			...
			<td valign="middle"><input type="submit" value="查询"
				class="button" /></td>
			<td width="20%" align="right"><a href="${ctx}/car/edit.do"><img
				src="${ctx}/images/icons/add.gif" />添加车辆信息</a></td>
		</tr>
	</table>
</s:form></div>
...
<table id="fineTable" width="800">
	...
	<s:iterator value="#attr.items" var="item" status="st">
		<tr onmousemove="this.className='trOver';"
			...
			<td><fmt:formatDate value="${item.buyInsureTime}"
				pattern="yyyy-MM-dd" /></td>
			<td><fmt:formatDate value="${item.auditTime}"
				pattern="yyyy-MM-dd" /></td>
