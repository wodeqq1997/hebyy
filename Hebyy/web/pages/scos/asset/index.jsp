...
<script type="text/javascript">
	function remove(id) {
		if(confirm("确认要删除该物资？")) {
			window.location.href = URL_PREFIX+"/asset/remove.do?model.id=" + id;
		}
	}
</script>
</head>
...
<div class="x-toolbar">
	...
	<table width="100%">
	  <tr>
			...
			<td align="right">
				<a href="${ctx}/asset/edit.do"><img src="${ctx}/images/icons/add_2.gif">&nbsp;添加物资</a>
				<a href="${ctx}/asset/type/index.do"><img src="${ctx}/images/icons/add.gif">物资类型</a>
				<img src="${ctx}/images/icons/folder.gif" class="icon">
	    	<a href="${ctx}/asset/instock/index.do">入库单管理</a>
			</td>
		</tr>
	</table>
	</s:form>
