...
<!--							<input name="button2" id="assetButton" type="button" class="button" onclick="" value="选择" />-->
					...
					<tr>
						...
						<td>
							<s:textfield name="model.reason" id="reason"  cssClass="required" maxlength="255" cssStyle="width: 450px;"/>
