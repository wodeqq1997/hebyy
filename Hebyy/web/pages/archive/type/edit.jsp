...
<s:form action="save.do" id="save" method="post">
	...
	<legend>案卷类型信息</legend>
	<table width="100%" align="left">
		<tr>
			<td align="right" width="100">案卷类型名称：</td>
			<td align="left">
				<s:textfield id="name" name="model.name" cssStyle="width:197px;" cssClass="required"/>
				<span id="nameDescn"></span>
				<font color="red">*</font>
			</td>
		</tr>
		<tr>
			<td align="right" width="100">案卷类型标示：</td>
			<td align="left">
				<s:textfield id="name" name="model.archiveNumMark" cssStyle="width:197px;" cssClass="required"/>
				<span id="nameDescn"></span>
				<font color="red">*</font>
			</td>
		</tr>
