	...
	<table width="100%">
		<tr>
			...
			<td class="simple"><s:textfield name="model.host"
				id="model.host" theme="simple"  cssClass="required"/><font color='red'>*</font></td>
		</tr>
		<tr>
			<td class="simple">端口号：</td>
			<td class="simple"><s:textfield name="model.port"
				id="port" theme="simple"  cssClass="required digits"/><font color='red'>*</font></td>
		</tr>
		<tr>
			<td class="simple">用户名：</td>
			<td class="simple"><s:textfield name="model.username"
				id="username" theme="simple"  cssClass="required"
		...
		<tr>
			...
			<td class="simple"><s:password name="model.password"
				id="model.password" theme="simple"  cssClass="required"></s:password><font color='red'>*</font></td>
		</tr>
		<tr>
