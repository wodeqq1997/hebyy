...
<br>
<s:form action="user/save" id="save" validate="true" method="post" onsubmit="disable1001()">
			...
			<td colspan="2" class="title">
				...
				<s:if test='editSelf == "1"'>
                    ...
                    <span style="display: inline-block;float: right;">
                        <s:checkbox name="notifiedMessage" style="vertical-align: middle;border: none"/>接收邮件通知
                        <s:checkbox name="_notifiedSms" style="vertical-align: middle;border: none"/>接收短信通知
                    </span>
				</s:if>
			</td>
		</tr>
		<tr>
			...
			<table width="400" border="0" style="line-height: 25px; ">
				...
				<tr>
					...
					<td>
						<s:textfield name="model.fileStorage" id="fileStorage" cssStyle="width:200px" maxlength="255" maxLength="6"/>
					</td>
				</tr>
			</table>
			</td>
