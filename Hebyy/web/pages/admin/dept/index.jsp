...
<div class="x-panel">
  <div class="x-toolbar" style="padding: 5px;" align="right">
	    <img src="${ctx}/images/icons/folder_go.gif"/><a href="${ctx}/admin/dept/edit.do"> 新建部门</a>
	    &nbsp;&nbsp;&nbsp;&nbsp;
	    <img src="${ctx}/images/grid/clear.png"/><a href="${ctx}/admin/dept/updateDeptSerialNo.do">重置部门编号</a>
	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </div>
...
<form action="${ctx}/admin/dept/edit.do" id="operator" method="get">
