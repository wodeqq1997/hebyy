...
<table width="100%" style="margin: 4px 0px;" cellpadding="0"
	...
	<tr>
		...
		<td width="80%" align="right"><a href="${ctx}/tsgl/queryxx1.do" title="返回"> <img src="${ctx}/images/icons/go.gif">&nbsp;返回</a></td>
	</tr>
</table>
</div>
...
<table id="fineTable" width="800">
	...
	<s:iterator value="jhList" var="item" status="st">
		<tr onmousemove="this.className='trOver';"
			...
			<td width="155" align="center"><s:if test='#attr.item.hsbz == null'>- -</s:if> ${item.hsbz}</td>
