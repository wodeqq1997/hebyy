...
<div id="content">
	...
	<s:form id="save" method="post" validate="true">
		...
		<tr>
			...
			<td ><s:select name="model.ruleType.id" list='typeMap' cssStyle="width:360px;height=22;" headerKey="" headerValue="请选择" cssClass="typeCheck" />
		...
		<tr>
			...
			<td ><s:textfield  name="model.wjh" cssStyle="width:360px;" cssClass="required"/>
				<font color="red">*</font>
			</td>
		</tr>
		<tr>
			<td align="right">文件内容：</td>
			<td><s:textfield  name="model.zdContent" cssStyle="width:360px" cssClass="required"/>
				<font color="red">*</font>
		...
		<tr height="36">
			...
			<div id="systop-uploaded-files" style="width: 410px; border-bottom: 1px solid #C3C3C3;"> <s:hidden id="fileAttchIds" name="model.fileAttachIds" /></div>
		...
		<tr>
			...
			<input type="button" onclick="javascript:window.location.href='${ctx}/rule/queryxx.do';" class="button" value=" 返 回 "></td>
		</tr>
		</s:form>
	</table>
...
<script type="text/javascript">
	...
	function jkjsSave() {
		$('#save').attr("action", "${ctx}/rule/save.do");
		$('#save').submit();
	}
</script>
<script type="text/javascript">
