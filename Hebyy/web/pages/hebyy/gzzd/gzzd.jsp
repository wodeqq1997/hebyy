...
<body>
	...
	<table width="100%" style="margin: 4px 0px;" cellpadding="0" cellspacing="0">
	  <tr>
	    <td width="70%">
	     	<s:form id="pageQueryForm" action="queryxx.do" cssStyle="margin:auto;" method="post">&nbsp;
					...
					关键字（模糊查询）：<s:textfield name="model.zdContent"
	  ...
	  <a href="${ctx}/zcxx/queryxx.do" title="章程目录管理"> 
						<img src="${ctx}/images/icons/add.gif">&nbsp;章程目录管理</a>
						&nbsp;&nbsp;
						<a href="toEdit.do?&&zx=0" title="添加规章制度条例"> 
