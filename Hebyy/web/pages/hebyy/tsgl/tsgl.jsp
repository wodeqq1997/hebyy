...
<body>
	...
	<table width="100%" style="margin: 4px 0px;" cellpadding="0" cellspacing="0">
	  ...
	  <a href="${ctx}/lbxx/queryxx.do" title="图书类别管理"> 
						<img src="${ctx}/images/icons/add.gif">&nbsp;图书类别管理</a>
						&nbsp;&nbsp;
						<a href="toEdit.do?&&zx=0" title="添加图书信息"> 
			...
			<table id="fineTable" width="800">
				...
				<s:iterator value="items"  var="item" status="st">
					<tr onmousemove="this.className='trOver';"
	                    ...
	                    <td width="75" align="center"><a href="view.do?model.id=${item.id}" title="查看详情"><font color="blue">${item.author}</font></a></td>
						...
						<td  width="150" align="center">${item.descn}
						
						
						
						
						
						<input type="hidden" name="item.lbxx.lbMc" value="${item.lbxx.lbMc}"/>
						</td>
